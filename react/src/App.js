    ...
    <div className="Shiraz">
      ...
      <article className="blog-post">
        ...
        <p>
          ...
          می‌شود.
		  پنج هتل برتر شیراز عبارت است از: هتل بزرگ شیراز، هتل چمران، هتل زندیه، هتل الیزه و هتل پارس.
        </p>
      </article>
    </div>
  );
    ...
    <div className="Mashhad">
      ...
      <article className="blog-post">
        ...
        <p>
		  ...
		  پنج هتل برتر شهر مشهد عبارت است از: هتل درویشی، هتل قصرطلایی، هتل مدینه الرضا، هتل اترک و هتل الماس.
        </p>
      </article>
    </div>
  );
    ...
    <div className="Tabriz">
      ...
      <article className="blog-post">
        ...
        <p>
		  ...
		  پنج هتل برتر تبریز عبارت است از: هتل کایا لاله پارک، هتل بین المللی تبریز، هتل بین المللی شهریار، هتل پارس ائل گلی و هتل گسترش تبریز.
        </p>
      </article>
    </div>
  );
    ...
    <div className="Yazd">
      ...
      <article className="blog-post">
        ...
        <p>
		  ...
		  پنج هتل برتر یزد عبارت است از: هتل صفاییه، هتل داد، هتل باغ مشیرالممالک، هتل ارگ جدید و هتل زنبق.
        </p>
      </article>
    </div>
  );
    ...
    <div className="Ardebil">
      ...
      <article className="blog-post">
        ...
        <p>
		  ...
		  پنج هتل برتر اردبیل عبارت است: هتل سبلان، هتل دریا، هتل مهدی، هتل شورابیل و هتل نادری.
        </p>
      </article>
    </div>
  );
  ...
  return (
    <div className="Gilan">
      ...
      <article className="blog-post">
        ...
        <p className="blog-post-meta">نوشته شده در 24 دی 99</p>
        <p>
         گیلان یکی از استان‌های شمالی ایران به مرکزیت کلانشهر رشت است. این استان، از شمال به دریای کاسپین و کشور آذربایجان، که از طریق آستارا با آن دارای 
		 مرز بین‌المللی است، از غرب به استان اردبیل، از جنوب به استان زنجان و قزوین و از شرق به استان مازندران محدود می‌شود. مساحت گیلان ۱۴٬۰۴۴ کیلومترمربع و 
		 جمعیت آن طبق سرشماری۱۳۹۵ ۲٬۵۳۰٬۶۹۶نفر است.
		 طبیعت گیلان، پوشیده از جنگل و دارای آب و هوای معتدل و مرطوب است. این استان شامل مناطق سرسبز شمال غربی رشته‌کوه البرز و بخش غربی کرانه‌های جنوبی 
		 دریای کاسپین است. گیلان به دلیل برخورداری از طبیعت غنی و میراث فرهنگی و تاریخی از قطب‌های گردشگری ایران به‌شمار می‌رود که سالانه بیش از ۵ میلیون گردشگر را 
		 از سراسر کشور جذب خود می‌کند. از جمله می‌توان به روستای ماسوله و دژ قلعه رودخان در فومن، شهر لاهیجان و بازارهای انزلی و آستارا اشاره کرد. 
		 منطقه گیلان دارای بارش فراوان است تا جایی که بارش سالانه شاید به ۱۲۰ سانتی‌متر هم برسد. مواد ساختمانی، جز صخره سخت، سریعاً خراب می‌شوند، و ساختمان‌های 
		 قدیمی تبدیل به تلی از آوار می‌شوند. درختان و علف‌های هرز بر این آوارها می‌رویند و ساختمان‌های قدیمی را تبدیل به تپه‌هایی پوشیده از گیاهان می‌کنند. 
		 استان‌های گیلان و مازندران در ایران دارای بیشترین تعداد بقعه و امامزاده‌اند که در اصل ائمه زیدی هستند. مقبره سید جلال الدین اشرف فرزند امام هفتم 
		 شیعیان در آستانه اشرفیه زیارتگاه شیعیان است. 
		 پنج هتل برتر گیلان عبارت است از: هتل کادوس رشت، هتل رسپینا لاهیجان، هتل معین فومن، هتل ستاره دریا لنگرود و هتل سغید کنار بندر انزلی.
        </p>
      </article>
    </div>
  );
    ...
    <div className="Mazandaran">
      ...
      <article className="blog-post">
        ...
        <p>
		  ...
		  پنج هتل برتر مازندران عبارت است از: هتل پارسیان آزادی خزر چالوس، هتل ونوس چالوس، هتل مروارید محودآباد، هتل بام سبز و هتل کیمیا در رامسر.
        </p>
      </article>
    </div>
  );
      ...
      <article className="blog-post">
        ...
        <p>
          ...
          واقع شده به همت حاج احمد گله‌داری مرمت شده‌است.
		   پنج هتل برتر بندرعباس عبارت است از: هتل هما، هتل هرمز، هتل آتیلار، هتل ایران و هتل امین.
        </p>
      </article>
    </div>
  );
    ...
    <div className="Kerman">
      ...
      <article className="blog-post">
        ...
        <p>
		  ...
		  پنج هتل برتر کرمان عبارت است از: هتل پارس، هتل اخوان، هتل جهانگردی، هتل ناز و هتل ایرانگردی.
        </p>
      </article>
    </div>
  );
    ...
    <div className="Semnan">
      ...
      <article className="blog-post">
        ...
        <p>
		  ...
		  پنج هتل برتر سمنان عبارت است از: هتل گوتکه مال، هتل دربند، هتل جهانگردی، هتل سنگسر و هتل سنتی خانه گل.
      </article>
    </div>
  );
}
