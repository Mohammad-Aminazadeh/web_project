    ...
    <div className="App">
      ...
      <footer className="blog-footer">
        <div className="row-md-6" id="about_us">
          <h3>ارتباط با ما</h3>
          <p>
           برای ارتباط با ما میتوانید با امیل یا تلفن همراه زیر استفاده کنید و سوالات خود را در رابطه ی با
گردشگری از ما بپرسید:
ایمیل: sorooshba@gmail.com
تلفن همراه: 09390125715 {" "}
          </p>
        </div>
      </footer>
    </div>
      ...
      <div className="row">
        <div className="col-md-12">
          <article className="blog-post">
            ...
            <p>
             این سایت برای راهنمایی گردشگران طراحی شده است. کسانی که میخواهند به مناطق مختلف ایران سفر کنند میتوانند با ورود به این سایت
از مطالب درباره گردشگری بهره مند شوند. کاربران میتوانند مطالب مرتبط با گردشگری درباره هر استان ایران را ببینند و در سفر خود
از این مطالب استفاده کنند.
در این سایت درباره هر استان مطالبی قرار داده شده است که کاربران میتوانند با ورود به لینک مرتبط با هر استان، با استان دلخواه خودشان آشنا شده
و مناطق مختلف استانها برای گردشگری را مطالعه کنند. همینطور برای هر استان پنج هتل برتر آن استان هم نوشته شده است تا کاربران با هتلهای برتر هر استان
آشنا شده و در سفر خود به یکی از این هتلها بروند.{" "}
            </p>
          </article>
        </div>
      </div>
