  ...
  return (
    <div className="Rasht">
      ...
      <article className="blog-post">
        ...
        <p className="blog-post-meta">نوشته شده در 24 دی 99</p>
        <p>
          رشت یکی از کلان شهرهای ایران و مرکز استان گیلان است. این کلانشهر
          همچنین پرجمعیت‌ترین شهر شمال ایران در بین سه استان حاشیه دریای خزر
          محسوب میشود. این شهر در سال ۲۰۱۵ به شبکه شهرهای خلاق جهان به عنوان شهر
          خلاق خوراک‌شناسی زیر نظر یونسکو پیوست.رشت تنها شهر ایران به همراه ۱۸
          شهر دیگر جهان است که در زمینه خوراک‌شناسی در یونسکو ثبت شد. شهر رشت با
          توجه به قدمت دیرینهٔ خود جایگاه بناهای تاریخی بسیاری است از جمله
          مهم‌ترین آن‌ها میدان شهرداری رشت است که شامل ساختمان شهرداری و برج
          ساعت آن که نماد شهر رشت می‌باشد و نیز موزه پست و ساختمان قدیمی هتل
          ایران است. مجموعه بناهای میدان شهرداری رشت در اوایل سلطنت رضا شاه
          پهلوی احداث شده‌است. برج ساعت شهرداری که نماد شهر رشت محسوب می‌شود، به
          هنگام وقوع زلزله مهیب و ویرانگر گیلان در سال ۱۳۶۹ ویران شده بود که
          چندی بعد به صورت سابق بازسازی گردید. شهر رشت داری ۴۰ پارک فعال است که
          بسیاری از آن‌ها مانند سبزه میدان دارای قدمت تاریخی‌اند. سرانه فضای سبز
          رشت کمتر از میانگین و استاندارد کشوری و حتی شهرهای کویری ایران کمتر
          است. در سال‌های اخیر از سوی شهرداری رشت فاز اول پارک مفاخر این شهر
          برای افزایش سرانه فضای سبز احداث شده و فاز دوم این پارک با توجه به
          قرار گرفتن چند خانه سازمانی اداره جنگل‌ها و مراتع علی‌رغم وجود مصوبه
          دولت قابل استفاده برای عموم مردم نیست. پارک ۴۰۰ هکتاری لاکان از دیگر
          وعده‌های استانداری گیلان برای جبران فقر فضای سبز کلانشهر رشت است که
          تاکنون عملیات اجرایی آن آغاز نشده‌است.
        </p>
      </article>
    </div>
  );
  ...
  return (
    <div className="Sari">
      ...
      <article className="blog-post">
        ...
        <p className="blog-post-meta">نوشته شده در 24 دی 99</p>
        <p>
          ساری از پرجمعیت‌ترین شهرهای شمال و پایتخت پیشین ایران، مرکز استان
          مازندران و شهرستان ساری است.این شهر پرجمعیت‌ترین و بزرگترین شهر استان
          مازندران و از بزرگترین شهرهای شمال کشور به‌شمار می‌رود. ساری به دلیل
          قرار گرفتن در شاهراه مسیر ارتباطی شرق به مرکز ایران از اهمیت خاصی
          برخوردار است.این شهر از شمال به دریای خزر و از جنوب نیز به جنگل و
          رودخانه ختم می‌شود. همچون سایر شهرهای شمالی، ساری از تولیدکنندگان
          مرکبات و یکی از قطب‌های تولید برنج و فراورده‌های دامی کشور است. این
          شهر یکی از مهم‌ترین مراکز گردشگری ایران به حساب می‌آید و و دارای
          مجموعه‌ای از جاذبه‌های گردشگری است. برج ساعت نماد ساری است و بیش از ۹۰
          سال قدمت دارد. طبق گزارش مرکز آمار در تابستان ۹۶، ساری به‌عنوان اولین
          شهر برتر گردشگرپذیر ایران با بیش از دو میلیون سفر تابستانی شناخته‌شد.
          همچنین در نوروز ۹۵ ساری، به‌همراه رامسر شهرهای برتر گردشگری ایران
          شدند. موقعیت جغرافیایی و مجاورت با دریا ی خزر و کوه سبب تنوع زندگی
          جانوری در ساری شده و مجموعه‌ای از جانوران کوهستانی، جنگلی، جلگه‌ای و
          همین‌طور پرندگان بومی مهاجر و آبزیان، شرایط زیستی متنوعی را به وجود
          آورده‌است. پناهگاه حیات وحش سمسکنده، دشت ناز، دودانگه و چهاردانگه و
          منطقه حفاظت‌شده بولا در حومه ساری واقع شدند.
        </p>
      </article>
    </div>
  );
